...
{	
	...
	public static void main(String[]args)
	{
		...
		System.out.println("enter the part of the first complex numbers:");
		int real1=sc.nextInt();
		System.out.println("enter the imaginary part of the first complex numbers:");
		int img1=sc.nextInt();
		System.out.println("enter the real part of the second complex number:");
		int real2=sc.nextInt();
		System.out.println("enter the imaginary part of the second complex numbers:");
		int img2=sc.nextInt();
